...
//for MPDI old version 
	...
	void	ExportPointDataList(class ATG::XMLWriter*e_pXMLWriter,cCueToStartCurveWithTime*e_pCueToStartCurvesWithTime);
#endif
	void	ExportMPDI(class ATG::XMLWriter*e_pXMLWriter,class cMPDIList*e_pMPDIList);
//end WIN32
#endif	
}
