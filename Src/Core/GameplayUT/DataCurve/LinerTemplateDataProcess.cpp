...
//template<>Field<Class> const CRTP<Class>::_field("blah");
	 template<>const wchar_t*         cLinerDataProcessor<Vector2>::TypeID( WSTRING(cLinerDataProcessor2) );
	 template<>const wchar_t*         cLinerDataProcessor<Vector3>::TypeID( WSTRING(cLinerDataProcessor3) );
	 template<>const wchar_t*         cLinerDataProcessor<Vector4>::TypeID( WSTRING(cLinerDataProcessor4) );
