...
//        l_pModel = LazyAddModel(l_pRootFrame, "glTFModel/sponza.glb");
        ...
        //l_pModel = LazyAddModel(l_pRootFrame, "glTFModel/ch1.glb");
        ...
        if (!l_pModel)
        {
            //l_pModel = LazyAddModel(l_pRootFrame, "glTFModel/Woman.gltf", 100);
             l_pModel = LazyAddModel(l_pRootFrame, "glTFModel/ch1.glb", 100);
        ...
        if (l_pModel && l_bDoAnimTexture&& l_pModel->IsContainAnimation())
        {
