...
cMatrix33& cMatrix33::operator=(const cMatrix33& copy)
{
...
cMatrix33 cMatrix33::Transposed() const
{
	cMatrix33 mx;
...
cMatrix33 cMatrix33::RotationMatrix(float angle)
{
	cMatrix33 m(identity);
...
cMatrix33 cMatrix33::TranslationMatrix(float tx, float ty)
{
	cMatrix33 m(identity);
	m[2][0] = tx; m[2][1] = ty;
	return m;
...
cMatrix33 cMatrix33::ScaleMatrix(float sx, float sy)
{
	cMatrix33 m(identity);
	m[0][0] = sx; m[1][1] = sy;
	return m;
